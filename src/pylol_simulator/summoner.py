...
class Summoner:
    ...
    # Create a attribute which is specified at runtime.
    def runtime_attribute(self, attribute, value):
        setattr(self, attribute, value)

    # Check if the Summoner has the specified runtime attribute.
    def has_runtime_attribute(self, attribute):
    ...
    # TODO: this will be updated later to reflect when champions can buff their bonus ad.
    @property
    def bonus_ad(self):
    ...
    @property
    def mana(self):
        return self.champion.mana + self.inventory.mana
    ...
    @property
    def ls(self):
        return self.inventory.ls

    # TODO find out how to implement mana into this
